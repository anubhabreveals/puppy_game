...
DUCKING = [pygame.image.load(os.path.join("Assets/Dog", "DogDuck1.png")),
           pygame.image.load(os.path.join("Assets/Dog", "DogDuck2.png"))]
...
POLICE = [pygame.image.load(os.path.join("Assets/Police", "Police1.png")),
        pygame.image.load(os.path.join("Assets/Police", "Police2.png"))]
...
class puppy:
    ...
    def update(self, userInput):
        ...
        if userInput[pygame.K_UP] and not self.dog_jump:
            self.dog_duck = False
            self.dog_run = False
            self.dog_jump = True
        elif userInput[pygame.K_DOWN] and not self.dog_jump:
            self.dog_duck = True
            self.dog_run = False
            self.dog_jump = False
        elif not (self.dog_jump or userInput[pygame.K_DOWN]):
            self.dog_duck = False
            self.dog_run = True
            self.dog_jump = False
    ...
    def duck(self):
        ...
        self.dog_rect = self.image.get_rect()
        self.dog_rect.x = self.X_POS
        self.dog_rect.y = self.Y_POS_DUCK
        self.step_index += 1
